...
* Who am I ?
  ...
  - Philippe Coval: [[https://twitter.com/@RzrFreeFr][@RzrFreeFr]]
    ...
    - OSS Advocates
    - Contributor to NuttX community
...
* Scripting MCUs
  - JavaScript: 
    - Language of the Web and beyond (Node.js)
...
:END:
   ...
   - Added patches for new Nulceo-F767ZI board
...
#+REVEAL: split
  ...
  - Thanks:
    - Alan, Alin and NuttX community !
    - Samsung-OSG, Mozilla, ST...
...
https://nuttx.events/wp-content/uploads/2019/11/banner-small-1.png
* Video playback
  @@html:<video controls src="https://video.fosdem.org/2020/UD2.218A/iotnuttx.webm"></video>@@
