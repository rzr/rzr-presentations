...
How to preserve your freedoms on your *personal* devices, without
loosing all "convenience" the modern "hyper connected world" is
offering (imposing) to us ?

This talk will share some recipes to replicate a selfhosted survival
kit.
...
* 
#+ATTR_HTML: :width 60% :align center style="border:0px solid black;"
...
* Add waydroid and apps
  - Start VM and log in pmOS:
    - sudo apk add [[https://wiki.postmarketos.org/wiki/Waydroid][waydroid]] cage # (...)
...
@@html:<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/eYOUKrU75XE#xdp-ng-waydroid-fosdem2026" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>@@

* What's next?
  * Keep hacking: UX/UI, RDP, tunnel
    - ARM translation to x86_64?
  * Challenges:
    - [[https://vates.tech/blog/vms-on-ampere-arm-processors/][Native ARM]] with [[https://xcp-ng.org/forum/topic/11698/xcp-ng-9.0-demonstrator-early-preview][XCP-ng 9]] (PoC)
