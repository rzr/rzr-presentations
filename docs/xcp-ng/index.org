#+TITLE:  Droids @ XCP-ng
#+AUTHOR: Philippe Coval <purl.org/rzr> #FOSDEM 2026
...
https://xcp-ng.org/forum/assets/uploads/system/site-logo.png
#+BEGIN_NOTES
...
* Motivations
  - Mobile apps: desired or imposed ?
    - Concerns: privacy, security, battery, obsolete.
    - vs web browser (PWA) on *any* devices
  - I made up a DiY "Apps on demand" web service:
    - Apps isolated/offloaded in VMs
      - Running home (in a PC, homelab) or cloud
...
*  
  ...
  https://xcp-ng.org/forum/assets/uploads/files/1769463428431-xcp-ng-jelly-fosdem-2026.png
